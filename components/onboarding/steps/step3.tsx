...
function Step3({ handleNext }: { handleNext: () => void }) {
  return (
    <div className="w-9/10 max-w-lg flex flex-col justify-between ">
      ...
      >
        ...
        <motion.div variants={item} className="space-y-2">
          ...
          <p className="text-4xl sm:text-5xl text-primary font-bold">Escrow</p>
          <p className="text-gray">
            Funds are held safely until both sides confirm. No trust issues. No
            scams. Just clean deals.
          </p>
        </motion.div>
